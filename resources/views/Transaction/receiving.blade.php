                ...
                <tbody>
                    @foreach ($contents as $index => $item)
                        <tr>
                            ...
                            <td>{{$item->TrxInNo}}</td>
                            <td>{{$item->WhsIdf}}</td>
                            <td>{{$item->TrxInDate}}</td>
                            <td>{{$item->TrxInSuppIdf}}</td>
...
$(document).ready(function(){
    ...
    var addBtn = '<div class="right" style="margin-left: 0.5em"><a class="btn btn-info" href="/receiving/add"><i class="bi bi-plus-square-fill"></i> Add New</a></div>';
