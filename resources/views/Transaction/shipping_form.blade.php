        ...
        <div class="card-body">
            <div class="header">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-input select2" id="customer">
                        @foreach ($customer as $item)
                        <option value="{{$item->CustomerPK}}">{{$item->CustomerName}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="mb-3">
            ...
            <a class="btn btn-success" id="submit_shipping">Submit</a>
        </div>
    </div>
@endsection
...
<script type="text/javascript">
    ...
    $('#submit_shipping').on('click', function(){
        var row = $('.table').find('tbody tr.details');
